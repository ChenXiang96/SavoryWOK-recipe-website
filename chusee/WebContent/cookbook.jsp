...
<div class="wrap">
  ...
  <div class="recipe_index_n10 mt20 clear jtl" style="display: flex !important; 
...
<a href="${ pageContext.request.contextPath }/findByCid/<c:out value="${c.cid}"/>/1" target="_blank" title="category" style="float: none !important;   <!-- 强制清除浮动 -->
                 display: block !important; <!-- 覆盖原有布局 -->
                 margin: 10px;">
<img class="imgLoad" src="${pageContext.request.contextPath}/<c:out value="${c.cimage}"/>" style="display: block;
                width: 75px;
                height: 75px;
                margin: 0 auto;">

<span style="font-size: 1.1em;   <!-- 相对单位放大 -->
              display: block;       <!-- 独占一行 -->
...
<c:out value="${c.cname}"></c:out>
  ...
  <div class="big4_list clear mt10" id="recipeindex_living">
		 ...
		 <li>
		  ...
		  <a title="cuisine item" href="${ pageContext.request.contextPath }/findByPid/<c:out value="${p.pid}"/>">
			  <i>

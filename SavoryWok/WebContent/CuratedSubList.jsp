...
<li class="show1" 
    ...
    <h1><a href="https://www.meishichina.com/mofang/dapaidang/" title="Theme Details" id="mof_h1">Theme Details</a></h1>
</li>
...
<a title="share" href="#" class="bds_tsina" id="bds_tsina" data-cmd="tsina"></a><a title="share" href="#" class="bds_qzone" id="bds_qzone" data-cmd="qzone"></a><a title="分享到QQ好友" href="#" class="bds_sqq" id="bds_sqq" data-cmd="sqq"></a><a data-cmd="weixin" id="bds_weixin" class="bds_weixin" href="#"></a>
</div>
</div>
...
<div class="msb_list clear">
    <ul>
        <c:forEach items="${dishesList}" var="dish">
            <li>
                <div class="pic">
                    <a href="${ctx}/getDishById/${dish.id}" target="_blank" style="float: none !important;   <!-- Force clearing of floats -->

...
<title>SavoryWok-Theme-Management</title>
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="style/images/title_arrow.gif" /> Theme Management
			</div>
		</div>
	...
	<div id="QueryArea">
		<form action="/wirelessplatform/food.jsp" method="get">
			<input type="hidden" name="method" value="search"> <input
				type="text" name="keyword" title="entername"> <input
			...
			<tbody id="TableData">
				<c:forEach items="${ list}" var="p">
					<tr class="TableDetail1">
						...
						<td>${p.pdate }</td>
						<td>12&nbsp;</td>
						<td><a href="${ctx }/subject/edit?pid=${p.pid}"
							class="FunctionButton">Edit</a> <a
							href="${ctx }/subject/delete?pid=${p.pid}"
							onClick="return delConfirm();" class="FunctionButton">Delete</a>
							<a href="${ctx }/subject/add" class="FunctionButton">Add</a></td>

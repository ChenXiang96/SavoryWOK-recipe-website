...
<body>
	...
	<div id="MainArea">
		...
		<form action="${ctx }/subject/update?pid=${subject.pid}" method="post"
				...
				<div class="ItemBlock">
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								<td width="80px">Theme</td>
								<td><select name="cid" style="width: 80px">

										<option value="1" selected="selected">Healthy</option>
							...
							<tr>
								...
								<td><input type="text" id="pname" name="pname"
									class="InputStyle" value="${subject.pname}" /></td>
							</tr>
							<tr>
								<td width="80px"></td>
								<td><input type="hidden" id="pid" name="pid"
									class="InputStyle" value="${subject.pid } " /></td>
							</tr>
							<tr>
								<td>Theme Description</td>
								<td><textarea name="pdesc" id="pdesc" class="TextareaStyle">${subject.pcontent }</textarea></td>
							</tr>
							<tr>

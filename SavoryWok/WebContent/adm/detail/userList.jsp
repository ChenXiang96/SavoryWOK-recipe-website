...
<title>SavoryWok-User-Management</title>
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="style/images/title_arrow.gif" /> User Management
			</div>
		</div>
	...
	<div id="QueryArea">
		<form action="/wirelessplatform/food.jsp" method="get">
			<input type="hidden" name="method" value="search"> <input
				type="text" name="keyword" title="enter user id"> <input
        ...
        <th>Options</th>
				...
				<c:forEach items="${ list}" var="user">
					<tr class="TableDetail1">
						...
						<td><c:choose>
								...
								<c:when
									test="${user.username == 'root' and user.password == 'root'}">
									<span style="color: #27ae60; font-weight: 600;">Admin</span>
								</c:when>
								
								<c:otherwise>
									<span style="color: #7f8c8d;">Standard User</span>
								</c:otherwise>
							</c:choose></td>
						<td>${user.password }</td>
						<td><img src="${ctx }/${user.uimage }" width="70" height="55" /></td>
						<td>2018/5/16</td>

						<td><a href="${ctx }/userback/delete?uid=${p.uid}"
			...
			<tr height="60">
				<td colspan="10" align="center" class="pagination-links"><a
					href="?pageNum=1" style="font-size: 16px !important;">First</a> │ <a
					href="?pageNum=${page.prePageNum }"

...
<title>SavoryWok-Post-Management</title>
...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="style/images/title_arrow.gif"/>Post Management
		</div>
    </div>
	...
	<div id="QueryArea">
		<form action="/wirelessplatform/food.jsp" method="get">
			...
			<input type="text" name="keyword" title="Enter User ID">
        ...
        <tbody id="TableData">
			...
			<tr class="TableDetail1">
				...
				<td>
					...
					<a href="${ctx }/topic/delete?tid=${p.tid}" onClick="return delConfirm();"class="FunctionButton">Delete</a>				
				</td>
			</tr>
        	</c:forEach>

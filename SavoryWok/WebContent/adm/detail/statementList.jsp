...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="style/images/title_arrow.gif"/> 评论列表
		</div>
    </div>
...
<div id="MainArea">
    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
        ...
        <tbody id="TableData">
			...
			<tr class="TableDetail1">
				...
				<td>
					<a href="updateStatement.jsp"  class="FunctionButton">更新</a>				
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		<div class="FunctionButton"><a href="saveStatement.jsp">添加</a></div>
    </div> 
